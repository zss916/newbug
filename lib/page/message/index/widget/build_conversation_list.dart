    ...
    /*  return CustomScrollView(
      slivers: [
        if (isNetLoss == true)
          ...
          SliverPadding(padding: EdgeInsetsDirectional.only(top: 14.h)),
        SliverList.separated(
          itemCount: logic.conversationsModelList.length,
          separatorBuilder: (BuildContext context, int index) =>
              Divider(height: 12.h, color: Colors.transparent),
          itemBuilder: (BuildContext context, int index) {
            final (RCIMIWConversation rCIMIWConversation, UserEntity userInfo) =
                logic.conversationsModelList[index];
            return Slidable(
              key: ValueKey("MsgTag$index"),
              groupTag: "MsgTags",
              enabled: true,
              ...
              child: InkWell(
                onTap: () {
                  RouteManager.toChat(targetId: rCIMIWConversation.targetId);
                },
                child: Container(
                  width: double.maxFinite,
                  height: 76,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            IntrinsicHeight(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (userInfo.isShowAddress)
                                    LocationWidget(address: userInfo.address),
                                  Spacer(),
                                  Container(
                                    alignment: Alignment.center,
                                    margin: EdgeInsetsDirectional.only(
                            ...
                            ConversationMsgWidget(value: rCIMIWConversation),
                          ],
                        ),
                      ),
                    ],
        ...
        SliverPadding(padding: EdgeInsetsDirectional.only(bottom: 76 - 14.h)),
      ],
    );*/
  }
}
