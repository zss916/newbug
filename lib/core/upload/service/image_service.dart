...
class ImageService {
  ...
  Future<File> compressAndGetFile(
    ...
    try {
      ...
      if (filePathLowerCase.endsWith(".jpeg") ||
  ...
  Future<File?> toCropImage(
    ...
    if (showLoading) {
      ToastUtil.loading("Image processing in progress...");
    }
  ...
  /// 保存到相册
  Future<bool> saveImage({required String url, bool showToast = true}) async {
    ...
    final message = isSuccess ? "Saved to the album" : "Operation failed";
